...
const ASSET_SECTIONS: AssetSection[] = [
	{
		title: "Symbol",
		description:
			"Use the symbol on its own when the ChronoX name is already present nearby or space is limited.",
		cols: "2",
		assets: [
			{
				src: "/logos/chronox/symbol.svg",
				theme: "dark",
				label: "Symbol",
				width: 400,
				height: 400,
			...
			{
				src: "/logos/chronox/symbol-light.svg",
				theme: "light",
				label: "Symbol",
				width: 400,
				height: 400,
	...
	},
	{
		...
		assets: [
			...
			{
				src: "/logos/chronox/logo-light.svg",
				theme: "light",
				label: "Logo",
				width: 1809,
				height: 400,
			...
			{
				src: "/logos/chronox/text-light.svg",
				theme: "light",
				label: "Text",
				width: 1760,
				height: 400,
...
export default function BrandPage() {
	return (
		<BasePage
			...
			description={
				<>
					Download ChronoX brand assets for use in your projects.{" "}
					<Link
						href="#guidelines"
			...
			<div id="guidelines" className="flex flex-col gap-8 text-sm">
				<div className="flex flex-col gap-3">
					...
					<p className="text-muted-foreground text-base leading-relaxed">
						ChronoX is open source — the code is free to use under its license.
						That license does not cover the name or logo. You can say you use
						ChronoX, that your project integrates with ChronoX, or that it was
						built on top of ChronoX. You cannot name your product ChronoX, imply
						we made or endorse your product, or use the marks commercially
						without asking first. For anything unclear, reach out at{" "}
						<Link
							href="mailto:brand@chronox.app"
							className="underline underline-offset-4"
						>
							brand@chronox.app
						</Link>
				...
				<div className="flex flex-col gap-3">
					...
					<ul className="text-muted-foreground text-base flex flex-col gap-2 leading-relaxed">
						{[
							"Using ChronoX in the name of your product, service, or domain.",
							"Implying that ChronoX made, sponsors, or endorses your work.",
