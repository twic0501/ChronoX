...
export const metadata: Metadata = {
	title: "Changelog - ChronoX",
	description: "What's new in ChronoX",
	openGraph: {
		title: "Changelog - ChronoX",
		description: "Every update, improvement, and fix to ChronoX — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in ChronoX">
