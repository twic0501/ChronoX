...
import { NewProjectDialog } from "@/components/editor/dialogs/new-project-dialog";
...
import { OcVideoIcon } from "@chronox/ui/icons";
...
function NewProjectButton() {
	return (
		<NewProjectDialog>
			<Button size="lg" className="flex px-5 md:px-6">
