...
export const metadata: Metadata = {
	title: "Terms of Service - ChronoX",
	description:
		"ChronoX's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - ChronoX",
		description:
			"ChronoX's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<p className="mt-4">
							...
							<a
								href="mailto:support@chronox.app"
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from ChronoX</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use ChronoX</h2>
				<p>ChronoX is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use ChronoX for client work and paid projects</li>
					<li>Share and distribute videos created with ChronoX</li>
					<li>
						Modify and distribute the ChronoX software (under MIT license)
					</li>
				</ul>
				<p>
					You're responsible for how you use ChronoX and the content you create.
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					...
					are optional - you can use ChronoX without them.
				</p>
			</section>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ChronoX does not currently require an account. The service is provided
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because ChronoX is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host ChronoX on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ChronoX is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update ChronoX and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using ChronoX at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
