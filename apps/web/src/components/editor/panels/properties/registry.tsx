...
import { ColourTab } from "./tabs/colour-tab";
import { OcShapesIcon } from "@chronox/ui/icons";
...
function buildColourTab({
	...
	return {
		...
		content: ({ trackId }) => <ColourTab element={element} trackId={trackId} />,
	};
}
