...
export function TransformTab({
	...
	return (
		...
		<Section collapsible sectionKey={`${element.id}:animation-presets`}>
			<SectionHeader>
				...
				<div className="grid grid-cols-2 gap-2 p-1">
					<Button
						...
						onClick={() => {
							editor.timeline.upsertKeyframes({
								keyframes: [
									{ trackId, elementId: element.id, propertyPath: "opacity", time: 0, value: 0 },
									{ trackId, elementId: element.id, propertyPath: "opacity", time: 1, value: 1 },
								],
							});
						}}
					>
					...
					<Button
						...
						onClick={() => {
							...
							editor.timeline.upsertKeyframes({
								keyframes: [
									{ trackId, elementId: element.id, propertyPath: "opacity", time: Math.max(0, dur - 1), value: 1 },
									{ trackId, elementId: element.id, propertyPath: "opacity", time: dur, value: 0 },
								],
							});
						}}
					>
					...
					<Button
						...
						onClick={() => {
							editor.timeline.upsertKeyframes({
								keyframes: [
									{ trackId, elementId: element.id, propertyPath: "transform.scaleX", time: 0, value: 0.8 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleX", time: 1, value: 1 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleY", time: 0, value: 0.8 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleY", time: 1, value: 1 },
								],
							});
						}}
					>
					...
					<Button
						...
						onClick={() => {
							...
							editor.timeline.upsertKeyframes({
								keyframes: [
									{ trackId, elementId: element.id, propertyPath: "transform.scaleX", time: Math.max(0, dur - 1), value: 1 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleX", time: dur, value: 0.8 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleY", time: Math.max(0, dur - 1), value: 1 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleY", time: dur, value: 0.8 },
								],
							});
						}}
					>
					...
					<Button
						...
						onClick={() => {
							editor.timeline.upsertKeyframes({
								keyframes: [
									{ trackId, elementId: element.id, propertyPath: "opacity", time: 0, value: 0 },
									{ trackId, elementId: element.id, propertyPath: "opacity", time: 0.5, value: 1 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleX", time: 0, value: 0.85 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleX", time: 0.5, value: 1 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleY", time: 0, value: 0.85 },
									{ trackId, elementId: element.id, propertyPath: "transform.scaleY", time: 0.5, value: 1 },
								],
							});
						}}
					>
