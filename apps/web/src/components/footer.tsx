			...
			<div className="mx-auto max-w-5xl px-8 py-10">
					...
					<div className="max-w-sm md:col-span-1">
						<div className="mb-4 flex items-center justify-start gap-2">
							<Image
								...
								width={24}
								height={24}
								className="bg-white rounded-sm p-0.5 object-contain"
							/>
							<span className="text-lg font-bold">ChronoX</span>
						</div>
						<p className="text-muted-foreground mb-5 text-sm md:text-left">
							The agentic local AI video workspace that feels simple to use.
						</p>
				...
				<div className="flex flex-col items-start justify-between gap-4 pt-2 md:flex-row">
					<div className="text-muted-foreground flex items-center gap-4 text-sm">
						<span>
							© {new Date().getFullYear()} ChronoX, All Rights Reserved
						</span>
					</div>
				</div>
			</div>
