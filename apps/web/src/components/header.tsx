						...
						<ContextMenuTrigger asChild>
							<Link href="/" className="flex items-center gap-2 select-none">
								<Image
									...
									alt="ChronoX Logo"
									className="bg-white rounded-md p-0.5 object-contain"
									width={28}
									height={28}
								/>
								<span className="font-orbitron font-bold text-base tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-600 dark:from-amber-400 dark:to-orange-500">
									CHRONOX
								</span>
							</Link>
						</ContextMenuTrigger>
